"""
Django settings for project_iiftaah project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-&^*@5#ia=@&q5v2e!gl1$n6a5nz5724m-om3wc6b8ultls#=ji')
...
ROOT_URLCONF = 'project_iiftaah.urls'
...
WSGI_APPLICATION = 'project_iiftaah.wsgi.application'
